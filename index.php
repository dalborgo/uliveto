...
<head>
    <meta charset="UTF-8">
    <title>Residence Uliveto | Homepage</title>
    <!-- reponsive meta -->
...
<div id="minimal-bootstrap-carousel" class="carousel default-home-slider slide carousel-fade shop-slider visible-xs hidden-sm"
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item  slide-2"
             style="background-image: url(images/slider/home2.jpg);backgroudn-position: center right;">
...
<!-- Search style-->
<!-- Descrizione iniziale - Activities of Resort style-->
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 activities-cont">
                <div class="sec-header3">
                    <h2>Il Residence</h2><br>
                    <!--                    <h3>Pick a room that best suits your taste and budget</h3>-->
                </div>
                <p>Posto all’interno di un grande <strong>parco di Ulivi Secolari</strong> (1500 mq), a pochi passi da
                    <strong>centro storico di Garda</strong> e a <strong>300 metri dalle spiagge del Lago</strong>, il
                    Residence “Uliveto” è il luogo ideale per chiunque desideri <strong>tranquillità</strong> e <strong>relax</strong>.
                </p>
        ...
        <div class="room-slider">
            <div class="roomsuite-slider-two">
                <div class="room-suite room-suite-htwo">
                    <div class="item">
                        <a rel="help" data-imagelightbox="g" href="images/slider/piccole/45.jpg">
